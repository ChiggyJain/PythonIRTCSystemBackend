...
export const options = buildSingleOptions('email_change_confirm', 1200, 1);
...
export default function () {
  ...
  const res = http.post(
    `${BASE_URL}/api/v1/users/email/change/confirm`,
    JSON.stringify({
    ...
    }),
    {
      ...
      tags: { endpoint: 'email_change_confirm' },
    }
  );

  check(res, {
    'email change confirm http 200': (r) => r.status === 200,
  });
}
