...
async def run_worker() -> None:
    ...
    producer = build_producer(
        client_id=f"{settings.KAFKA_CLIENT_ID}-stations-outbox-publisher"
    )
    await producer.start()
    app_logger.info("stations_outbox_worker started")
