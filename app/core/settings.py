...
class Settings(BaseSettings):
    ...
    KAFKA_PAYMENT_UPDATED_STATUS_TOPIC: str = "payment-updated-status"
    KAFKA_PAYMENT_UPDATED_STATUS_TOPIC_CONSUMER_GROUP: str = "payment-updated-status-consumer-group"
