...
class PaymentOrdersUpdatedStatusOutboxRetryHandler(OutboxBaseRetryHandler):
    ...
    async def handle(self, **kwargs):
        ...
        max_retries = int(settings.KAFKA_BOOKING_PAYMENT_SUCCESSFAILED_OUTBOX_MAX_RETRIES)
